...
.mode insert prompts
SELECT id, event_id, user_id, contents, rating, approvals, created FROM prompts;
...
.mode insert entrys
SELECT NULL, event_id, artist_id, id, NULL, NULL, title, seed, disqualified,
...
SELECT NULL, event_id, artist_id, NULL, id, NULL, title, seed, 0,
